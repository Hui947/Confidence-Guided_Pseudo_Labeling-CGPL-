...
from .backbones.vit_pytorch_uda import uda_vit_base_patch16_224_TransReID, uda_vit_small_patch16_224_TransReID, uda_vit_tiny_patch16_224_TransReID
...
class build_transformer(nn.Module):
    def __init__(self, num_classes, camera_num, view_num, cfg, factory):
        ...
        if '384' in cfg.MODEL.Transformer_TYPE or 'small' in cfg.MODEL.Transformer_TYPE:
            self.in_planes = 384 
        elif '768' in cfg.MODEL.Transformer_TYPE or 'base' in cfg.MODEL.Transformer_TYPE:
            self.in_planes = 768
        elif '192' in cfg.MODEL.Transformer_TYPE or 'tiny' in cfg.MODEL.Transformer_TYPE:
            self.in_planes = 192
...
__factory_hh = {
    ...
    'uda_vit_tiny_patch16_224_TransReID': uda_vit_tiny_patch16_224_TransReID,
    # 'resnet101': resnet101,
}
