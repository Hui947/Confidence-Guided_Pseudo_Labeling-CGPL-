# '../logs/pretrain/'$model'/domainnet/Painting/domainnet_pretrain_pnt_vit_base_768.pth'
model=$1
if [ ! -n "$1" ]
then 
...
for target_dataset in 'clipart' 'infograph' 'quickdraw' 'real' 'sketch' 
do
    python train.py --config_file configs/uda.yml MODEL.DEVICE_ID $gpus\
    OUTPUT_DIR '../logs/uda/'$model'/domainnet/painting2'$target_dataset'/111'  \
    MODEL.PRETRAIN_PATH '../logs/pretrain/'$model'/domainnet/Painting/domainnet_pretrain_pnt_vit_base_768.pth' \
