# '../logs/pretrain/'$model'/domainnet/Quickdraw/domainnet_pretrain_qdr_vit_base_768.pth'
model=$1
if [ ! -n "$1" ]
then 
...
do
    ...
    OUTPUT_DIR '../logs/uda/'$model'/domainnet/quickdraw2'$target_dataset'/111'  \
    MODEL.PRETRAIN_PATH '../logs/uda/'$model'/domainnet/quickdraw2sketch/111/transformer_best_model_48.3.pth' \
