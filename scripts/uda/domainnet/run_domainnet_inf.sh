...
for target_dataset in 'clipart' 'painting' 'quickdraw' 'real' 'sketch'
do
    python train.py --config_file configs/uda.yml MODEL.DEVICE_ID $gpus \
    OUTPUT_DIR '../logs/uda/'$model'/domainnet/infograph2'$target_dataset'/111'  \
    MODEL.PRETRAIN_PATH '../logs/pretrain/'$model'/domainnet/Infograph/domainnet_pretrain_inf_vit_base_768.pth' \
