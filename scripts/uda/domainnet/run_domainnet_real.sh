# '../logs/pretrain/'$model'/domainnet/Real/domainnet_pretrain_rel_vit_base_768.pth'
model=$1
if [ ! -n "$1" ]
then 
...
do
    ...
    OUTPUT_DIR '../logs/uda/'$model'/domainnet/real2'$target_dataset'/111'  \
    MODEL.PRETRAIN_PATH '../logs/pretrain/'$model'/domainnet/Real/domainnet_pretrain_rel_vit_base_768.pth' \
